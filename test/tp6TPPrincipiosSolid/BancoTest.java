...
class BancoTest {
	...
	void setUp() throws Exception {
		...
		giuliana = new Cliente("giuliana", "mongues", "lissandroDeLaTorre", 24, 45.000, solicitudCreditoHipotecario2,
				torresDeGuido);
	...
	void test03BancoDesembolsaDineroAlClienteGiuliana() {
		...
		assertEquals(solicitudCreditoHipotecario2
				.montoTotalSolicitadoNoEsMayorAlSetentaPorCientoDelValorFiscalComoGarantia(), true);
